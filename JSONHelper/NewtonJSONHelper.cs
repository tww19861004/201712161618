...
namespace LightHelper.NewtonJSONHelper
{
    public static partial class NewtonJSONHelper
    {
        ...
        {
            return ToJson(obj, Indented?Formatting.Indented:Formatting.None, JsonSettings);
        }
